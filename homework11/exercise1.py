...
""" class Dish:
    def __init__(self, name: str, amount: int, price: float, weight: float):
        self.name = name
        self.amount = amount
        self.price = price
        self.weight = weight
...
class Order(Dish):
    def __init__(self, amount: int, price: float, weight: float):
        super().__init__(amount, price, weight)
